...
# Test plot
As a test you can see the plot of the signal from the PMT with NaI:Tl crystal on the input
window with Cs<sup>137</sup> gamma-source (the code is available
here: `example/ROOT/draw/`) and integral spectrum of that record (the code for `TTree`
